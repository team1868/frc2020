...
class TrenchAlignTapeCommand : public AutoCommand {
public:
    TrenchAlignTapeCommand(RobotModel* robot, ControlBoard* humanControl, NavXPIDSource* navXSource, TalonEncoderPIDSource* talonSource, bool driveStraightDesired);
    virtual ~TrenchAlignTapeCommand();
