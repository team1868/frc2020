...
// AlignTapeCommand::AlignTapeCommand(RobotModel* robot, ControlBoard* humanControl, NavXPIDSource* navXSource, TalonEncoderPIDSource* talonSource, bool driveStraightDesired, double desiredRelativeAngle) : AutoCommand() {
...
//     desiredDeltaAngle_ = desiredRelativeAngle;//robot_->GetDeltaAngle();
//     desiredDistance_ = desiredDistance;//robot_->GetDistance();
...
// 	//HOLD UP THIS IS AN ERROR TODO READ FROM JETSON ISNT CONSTANTLY CALLED
...
// 		printf("vision done at: %f\n", robot_->GetTime() - initTimeVision_);
// 		printf("ANGLE WAS GOOD, NO PIVOT at angle: %f\n", -desiredDeltaAngle_);
// 		if(driveStraightDesired_) {
// 			printf("driving now");
// 			nextState_ = kUpdate;
// 		} else {
// 			printf("driving not desired, leaving");
// 			isDone_ = true;
// 		}
// 	}
// 	robot_->SetAlignSequence(stringSequence_);
...
// 			break;
// 		default:
// 			printf("ERROR in initialization in align tape state machine\n");
// 	} 
...
// 	isDone_ = true;
// 	delete anglePIDOutput_;
// 	delete distancePIDOutput_;
// }
