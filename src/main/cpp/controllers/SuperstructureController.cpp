        ...
        case kClimbing:
            ...
            switch(currClimbingState_){
                ...
                case kClimbingElevator:
                    ...
                    if(!humanControl_->GetDesired(ControlBoard::Buttons::kClimbRightElevatorUpButton)||!humanControl_->GetDesired(ControlBoard::Buttons::kClimbRightElevatorDownButton)){
